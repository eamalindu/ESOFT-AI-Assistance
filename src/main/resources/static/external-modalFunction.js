function showCustomModal(msg,type) {
    ...
    if(type ==="warning"){
        modalBodyGif.src='images/warning.gif';
    }
    else if (type==="error"){
        modalBodyGif.src='images/error.gif';
        modalBodyGif.classList.add('ps-2');
    }
    else if(type ==="success"){
        modalBodyGif.src='images/success.gif';

    }
    else{
        modalBodyGif.src='images/info.gif';
    }
...
function showCustomConfirm(msg, result) {
    ...
    modalBodyGif.src = 'images/alert.gif';
