...
public class GeminiService {
    ...
    private void loadPredefinedCommands() {
        ...
        predefinedCommands.put("Hello!","HI there! How can I help you?");
        predefinedCommands.put("Access Code eamalindu", "Welcome Back Mr. Malindu Prabodhitha.<br>");
        predefinedCommands.put("/Pubudushani", "Ruwanthika **Pubudushani** is a lecturer of our branch");
        predefinedCommands.put("/Wageesha", "Wageesha **Thathsarani** is a lecturer of our branch");
